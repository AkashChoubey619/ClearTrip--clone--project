...
import LoginImg1 from '../../Assets/Login/LoginImg2.webp'
                            ...
                            <Box>
                                <Dropdown>
                                    ...
                                    <Menu slots={{ listbox: AnimatedListbox }}>
                                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingBlock: '8px' }}>number</div>
                                        <Divider flexItem />
                                    ...
                                    <Box sx={{ p: '4px 16px' }}>
                                        ...
                                        <Box>
                                            {modalToggle === 'signUp' ? (<form>
                                                <label style={{ marginBottom: '4px', fontWeight: 600, display: 'block', fontSize: '12px', letterSpacing: '1px' }} htmlFor='name'>Username</label>
